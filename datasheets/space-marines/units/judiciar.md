...
**Invulnerable Save:** 4+ (melee attacks only)
...
### Tempormortis
While this model is leading a unit, that unit has the Fights First ability.
...
- Wahapedia: https://wahapedia.ru/wh40k10ed/factions/space-marines/Judiciar
- Munitorum Field Manual v3.9 (Feb 2026), Codex: Space Marines section

<!-- Last verified: 2026-04-21 — source: Wahapedia https://wahapedia.ru/wh40k10ed/factions/space-marines/Judiciar / MFM v3.9 -->
