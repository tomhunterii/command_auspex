---
slug: vanguard-veteran-squad-with-jump-packs
...
**Unit Keywords:** Infantry, Grenades, Jump Pack, Fly, Imperium, Vanguard Veteran Squad, Vanguard Veteran Squad with Jump Packs
...
**Invulnerable Save:** 4+ (only models equipped with storm shield)
...
| Grav-pistol                  | 12"   | 1  | 3+ | 4 | -1 | 1  | [ANTI-VEHICLE 2+], [PISTOL]           |
...
### Vanguard Assault
Each time this unit ends a Charge move, until the end of the turn, melee weapons equipped by models in this unit have the [LETHAL HITS] ability.
...
Every model is equipped with: bolt pistol; Vanguard Veteran weapon.

---

## Wargear Options

- Any number of models can each have their bolt pistol replaced with one of the following: 1 storm shield; 1 grav-pistol; 1 hand flamer; 1 inferno pistol; 1 plasma pistol.
